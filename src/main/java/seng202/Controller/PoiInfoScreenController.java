...
/**
 * Controller class for the poi information screen.
 */
public class PoiInfoScreenController {
    ...
    /**
     * Method for when the update button is pressed, displays text fields for updating selected    
     * poi.
     * @param event - Auto-generate event on button press
     */
    @FXML
     ...
     * Checks that the inputed data is valid then updates the poi in the list and database.
     * @param event - Auto-generate event on button press
     */
    @FXML
    void savePressed(ActionEvent event) {
        ...
        if (allValid) {
    	    if (addressText.getText() != null && !oldPoi.getAddress().equals(
    	    		addressText.getText())) {
    ...
    void showPoiOnMap(ActionEvent event) throws IOException {
        ...
        controller.getMapView().addMapReadyListener(new MapReadyListener() {
            ...
            public void mapReady() {
                ...
                controller.getMapView().getMap().setCenter(new LatLong(poi.getLatitude(), 
                		poi.getLongitude()));
    ...
    void initialize() {
        ...
        assert costLabel != null : "fx:id=\"costLabel\" was not injected: check your FXML file "
        		+ "'PoiInfoScreen.fxml'.";
        assert descriptionLabel != null : "fx:id=\"descriptionLabel\" was not injected: check your"
        		+ " FXML file 'PoiInfoScreen.fxml'.";
