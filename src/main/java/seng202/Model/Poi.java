...
/**
 * Point of Interest (POI) subclass of location, stores a description of the location and the 
 * cost of visiting.
 */
public class Poi extends Location {
    ...
    /**
     * The POI constructor, creates a new instance of the point of interest object using the 
     * location superclass constructor.
    ...
    public boolean equals(Object poi) {
        ...
        if (this.getLatitude() == otherPoi.getLatitude() && 
        		this.getLongitude() == otherPoi.getLongitude() &&
                this.getName().equals(otherPoi.getName()) && 
                this.getDescription().equals(otherPoi.getDescription())) {
            return true;
        }
        return false;
    }
