...
/**
 * Retailer subclass of Location, contains the type of product sold, and a description of the 
 * retailer.
 */
public class Retailer extends Location {
	 ...
	 */
    public Retailer(double latitude, double longitude, String name, String product, 
    		String description) {
     ...
     * @param description - A general description of what the retailer sells
     */
    public Retailer(double latitude, double longitude, String address, String name, 
