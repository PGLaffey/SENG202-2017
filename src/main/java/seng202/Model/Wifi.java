...
public class Wifi extends Location {
     ...
     */
    public Wifi(double latitude, double longitude, String name, String ssid, String type, 
    		String provider) {
    ...
    /**
     *  Override the .equals method to checks if two wifi objects are equal to one another.
